#!/usr/bin/env python3
# 使用 /workspace/preprocessed_data.csv 训练三层架构模型
...
# 加载数据
data_path = '/workspace/preprocessed_data.csv'
...
# 保存结果
output_path = '/workspace/Project_mat/data/processed/three_layer_result_from_csv.pkl'
print(f"\n保存结果到: {output_path}")
